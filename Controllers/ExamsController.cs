...
namespace E_Exam.Controllers
{
    public class ExamsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SubjectId,ProfessorId,AllowedTime")] Exam exam)
        {
            ...
            ViewData["SubjectId"] = new SelectList(_context.Subjects, "Id", "Department", exam.SubjectId);
            return View(exam);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SubjectId,ProfessorId,AllowedTime")] Exam exam)
        {
            if (id != exam.Id)
            {
                return NotFound();
