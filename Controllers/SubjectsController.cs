...
namespace E_Exam.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Level,Department")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Level,Department")] Subject subject)
        {
            if (id != subject.Id)
            {
                return NotFound();
