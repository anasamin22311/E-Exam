...
namespace E_Exam.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,Type,Difficulty,ChapterId")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,Type,Difficulty,ChapterId")] Question question)
        {
            if (id != question.Id)
            {
                return NotFound();
